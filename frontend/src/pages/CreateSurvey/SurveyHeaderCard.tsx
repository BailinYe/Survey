            ...
            <CardContent className="space-y-6 p-6">
                <div className="space-y-2">
                    <Input
                        ...
                        className="h-12 rounded-none border-0 border-b border-border bg-transparent px-0 text-2xl
                ...
                <div className="space-y-2">
                    <Textarea
                        ...
                        rows={1}
                        className="resize-none rounded-none border-0 border-b border-border bg-transparent px-0
